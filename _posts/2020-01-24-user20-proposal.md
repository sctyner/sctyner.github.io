...
Today, the useR! 2020 committee announced the July 7th tutorials on [twitter](https://twitter.com/useR2020stl/status/1220451345360179200). I am so honored and grateful to be one of the selected tutorial leaders! What an amazing group to be a part of! 

I will be giving the tutorial, "Creating Beautiful Data Visualizations in R: a `ggplot2` Crash course." The other tutorials are: 

- Morning session:  
    * First steps in spatial data handling and visualization by [S. Rochette](https://github.com/statnmap), D. Scott, and [J. Nowosad](https://nowosad.github.io/)
    * Predictive modeling with text using tidy data principles b [J. Silge](https://juliasilge.com/) and E. Hansen 
    * So, you want to learn Python? An introduction to Python for the R lover [S. Ellis](http://www.shanellis.com/)
    * Application of Gaussian graphical models to metabolomics [D. Scholtens](https://www.feinberg.northwestern.edu/faculty-profiles/az/profile.html?xid=16163) and [R. Balasubramanian](https://www.umass.edu/sphhs/person/faculty/raji-balasubramanian)
