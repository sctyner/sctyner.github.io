...
analyzing justice statistics; and disseminates high value information and statistics to inform policymakers, researchers, criminal justice practitioners and the general public." 
    ...
    - ~~API~~ Prayer directed at CSVs living here: https://www.bjs.gov/datacollection.cfm  
...
4. Bureau of Transportation Statistics (BTS): (15/84  $\approx$ 18%) 
    ...
    - ~~API~~ Prayers directed at: https://www.bts.gov/browse-statistical-products-and-data (but they have an [app](https://www.bts.gov/browse-statistical-products-and-data/pocket-guide-transportation/pocket-guide-transportation), so I guess that's cool?) 
...
: https://www.dhs.gov/dhs-developer-community    a. Citizenship and Immigration Services (CIS) : https://www.uscis.gov/tools/reports-studies/immigration-forms-data 
...
1. Department of the Interior
 : https://www.doi.gov/data, https://data.doi.gov/dataset    a. Bureau of Land Management (BLM) : https://www.blm.gov/about/data
...
1. Department of State
 : https://www.state.gov/api/v1/docs/, https://www.state.gov/developer/, https://www.state.gov/data/    a. Office of the U.S. Global AIDS Coordinator (OGAC) :https://www.pepfar.gov/priorities/data/index.htm, https://www.hiv.gov/locator#api 
